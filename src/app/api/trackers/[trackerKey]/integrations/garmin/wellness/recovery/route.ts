import { garminWellnessRecoveryResponseSchema } from "@/domain/garmin";
...
export async function POST(
  ...
  try {
    ...
    const result = await createDefaultGarminRuntime().recoverWellnessHistory({
      trackerKey,
    });
    return Response.json(garminWellnessRecoveryResponseSchema.parse(result), {
